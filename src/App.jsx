...
import { BakeShadows, CubeCamera, Environment, OrbitControls, TorusKnot, useBoxProjectedEnv, useGLTF } from '@react-three/drei'
import { Canvas, applyProps } from '@react-three/fiber'
import { useControls } from 'leva'

export default function App() {
  return (
    <Canvas frameloop='demond' dpr={[1, 1.5]} shadows camera={{ near: 0.1, far: 40, fov: 75 }}>
      ...
      <Environment files="/noon_grass_1k.hdr" background />
      <BakeShadows />
    </Canvas>
  )
}
